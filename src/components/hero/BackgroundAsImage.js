...
const SlantedBackground = styled.span`
  ${tw`relative text-orange-500 px-4 -mx-4 py-2 text-5xl`}
  &::before {
    content: "";
...
const PrimaryAction = tw.button`px-8 py-3 mt-10 text-sm sm:text-base sm:mt-16 sm:px-8 sm:py-4 bg-orange-500 text-white font-bold rounded shadow transition duration-300 hocus:bg-black hocus:text-orange-400 focus:shadow-outline`;
        ...
        <TwoColumn>
          <LeftColumn>
            ...
            <Heading>
              ...
              <br />
              <SlantedBackground>Voice Over Talents.</SlantedBackground>
            </Heading>
            <PrimaryAction>Hire a Talent Now</PrimaryAction>
          </LeftColumn>
          <RightColumn>
